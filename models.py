...
class Encoder(nn.Module):
  """Perform ViT temporal encodings and T5 text encodings separately."""
  enc_type: str
...
class EncDecImageModule(EncoderDecoderModule):
...
class EncDecLanguageModel(base_model.BaseModel):  
